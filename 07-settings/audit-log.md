...
**Change control verification** — confirm that rule changes happened in the right sequence and were made by authorised users. Cross-reference with the [rule audit trail](../05-mapping-rules/rule-audit-trail.md) for the before-and-after state of each rule change.
