...
This walkthrough takes you from nothing to a registered, tested inbound adapter. It assumes you have read the [adapter specification](adapter-spec.md) and understand the four required methods.
...
- Rules 2–8: see the [adapter specification](adapter-spec.md#normalizeinput) for the full list.
...
→ See [adapter specification § registration](adapter-spec.md#registration) for full details
