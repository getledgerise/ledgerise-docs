...
→ Full pre-activation checklist: [sandbox to production](../02-deployment/sandbox-to-production.md)
...
- Monitor the first 48–72 hours closely. → See [what to monitor after go-live](../01-getting-started/quickstart.md#what-to-monitor-after-go-live)
