...
| `completed_at` | datetime or null | Yes | When the transaction was finalized. Null means still pending. |
...
| `completed` | Transaction is final. Eligible for journal posting. |
