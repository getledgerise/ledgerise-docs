...
- If you are setting up Ledgerise for the first time, follow the [quickstart](04-quickstart.md).
- If you are looking for definitions of specific terms, see [key concepts](03-key-concepts.md).
- For full deployment instructions, see [deployment overview](../02-deployment/01-overview.md).
