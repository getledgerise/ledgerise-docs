...
**Who this is for:** Admins completing the initial setup. If you are a Finance Officer joining an already-configured Ledgerise deployment, you can start directly with [mapping rules](../05-mapping-rules/01-overview.md) or [reconciliation](../04-reconciliation/01-overview.md).
...
→ Full instructions: [chart of accounts](../05-mapping-rules/04-chart-of-accounts.md)
...
→ Full instructions: [webhook adapter](../08-adapters/04-generic-webhook.md) | [csv import](../08-adapters/05-generic-csv.md) | [poll adapter](../08-adapters/06-generic-poll.md)
...
→ Full instructions: [reconciliation overview](../04-reconciliation/01-overview.md) | [reconciliation rules](../04-reconciliation/05-reconciliation-rules.md)
...
→ Full instructions: [users and roles](../07-settings/02-users-and-roles.md)
