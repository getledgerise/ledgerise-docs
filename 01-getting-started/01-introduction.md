...
If you want to understand how Ledgerise works before touching anything, read [how ledgerise works](02-how-ledgerise-works.md).

If you are the person setting up Ledgerise for your organisation and want to get started quickly, go to the [quickstart](04-quickstart.md).

If you have encountered a term in this documentation that you are not familiar with, the [key concepts](03-key-concepts.md) page explains the vocabulary used throughout.
