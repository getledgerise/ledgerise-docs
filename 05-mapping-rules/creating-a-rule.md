...
- The **debit and credit account codes** from your chart of accounts. → See [chart of accounts](chart-of-accounts.md) if you have not imported your COA yet.
...
→ Full instructions: [unmapped transactions](../03-transactions/unmapped-transactions.md)

---

## next steps

- [Rule resolution order](rule-resolution-order.md) — understand which rule wins when more than one could match a transaction
- [Rule audit trail](rule-audit-trail.md) — see how every change to this rule is tracked
