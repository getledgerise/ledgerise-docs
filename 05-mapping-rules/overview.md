...
- [Creating a rule](creating-a-rule.md) — step-by-step instructions for adding your first rules
- [Rule resolution order](rule-resolution-order.md) — how the engine picks a rule when more than one could match
- [Chart of accounts](chart-of-accounts.md) — where the debit and credit accounts in your rules come from
- [Rule audit trail](rule-audit-trail.md) — how every change to a rule is tracked
