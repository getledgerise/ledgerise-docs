...
→ See [transaction schema reference](../12-reference/transaction-schema.md) for the full canonical field list.
...
→ Full guide: [webhook adapter](webhook-adapter.md)
...
→ Full guide: [csv import](csv-import.md)
...
→ Full guide: [poll adapter](poll-adapter.md)
...
→ See [journal log](../06-journal-log/overview.md) to monitor engine runs and entry outcomes.
