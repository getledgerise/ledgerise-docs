...
Alphabetical reference for Ledgerise terminology. For conceptual introductions, see [key concepts](../01-getting-started/key-concepts.md).
...
→ See [adapters overview](../08-adapters/overview.md)
...
→ See [rule resolution order](../05-mapping-rules/rule-resolution-order.md)
...
→ See [transaction schema](transaction-schema.md)
...
→ See [journal entries](../06-journal-log/journal-entries.md)
...
→ See [activating your license](../09-licensing/activating-your-license.md)
...
→ See [system settings](../07-settings/system-settings.md)
...
→ See [first login](../02-deployment/first-login.md)
...
→ See [rule audit trail](../05-mapping-rules/rule-audit-trail.md)
